<div class="row">
	<!-- FORM -->
	<form class="col-lg-12 col-md-12" action="{{ route('loading.action-log-name',app()->getLocale()) }}" method="POST" name="importform" enctype="multipart/form-data">
										@csrf
