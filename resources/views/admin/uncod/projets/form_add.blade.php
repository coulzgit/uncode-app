			...
			<div class="card-body">
				...
				<div class="pd-30 pd-sm-40 bg-gray-200">
					...
					<div class="row row-xs align-items-center mg-b-20">
						...
						<div class="col-md-8 mg-t-5 mg-md-t-0">
							<input id="projet_name" required=""  value="" class="form-control" placeholder="{{__('Saisir le nom du projet')}}" type="text">
						</div>
					</div>
					
					<button onclick="createProjet()" class="btn btn-main-primary pd-x-30 mg-r-5 mg-t-5">{{__('Sauvegarder')}}</button>
