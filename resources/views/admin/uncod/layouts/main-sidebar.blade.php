	...
	<div class="main-sidemenu">
		<div class="app-sidebar__user clearfix">
			<div class="dropdown user-pro-body">
				<div class="">
					<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('uncode/marque_blanches/miniatures/'.$user_auth['photo'])}}">
					<span class="avatar-status profile-status bg-green"></span>
				</div>
				<div class="user-info">
					<h4 class="font-weight-semibold mt-3 mb-0">{{$user_auth['user_name']}}
					</h4>
							...
							@foreach($projets as $projet)
								<li>
									<a class="sub-slide-item" 
										href="{{route('projects.invoices',['projet_id'=>$projet->id ,'locale'=>app()->getLocale()])}}"


										>
										{{$projet->nom}}-- <span style="text-transform: lowercase;">{{__('Compte')}}</span>--{{$projet->account->code}}--
									</a>
								</li>
							@endforeach
						@else
