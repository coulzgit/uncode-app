...
/* ##########  USER - RULES - PERMISSIONS ########## */
    public function index(Request $request) 
    {
        ...
        return view('mytestes.users.index',compact('data'))
        ->with('i', ($request->input('page', 1) - 1) * 5);
    } 
    public function create()
    {   
        $roles = Role::pluck('name','name')->all();
        // return view('admin.uncod.comptes_clients.add_user.index',compact('roles'));
        return view('mytestes.users.create',compact('roles'));
    }
    ...
    {
        $user = User::find($id);
        return view('mytestes.users.show',compact('user'));
    }
    ...
    {  
        ...
        return view('mytestes.users.edit',compact('user','roles','userRole'));
    }
...
/* ################ MODULE ACCOUNT################### */
    ...
    public function saveConfigAccount(Request $request)
    {
