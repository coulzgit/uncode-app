...
class IpLineItemParam extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['ip_line_item_id', 'LIP_DATA_FIELD', 'LIP_COMP_NO', 'LIP_FIELD_LABEL', 'LIP_DATA_TYPE', 'LIP_SCREEN_POSITION', 'LIP_FIELD_LENGHT', 'LIP_SHOW_IN_CLIENT', 'LIP_ORDER_ROW_DATA_FIELD', 'LIP_ORDER_ROW_DATA_FIELD_LABEL', 'LIP_ASSOSIATION_FIELD', 'LIP_RULES_FIELD', 'lip_col_order', 'created_at', 'updated_at'];
