        ...
        <div class="left-content">
            <div>
              <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">
                <?php echo e(__('Créer un nouveau rôle')); ?>
...
<?php echo $__env->make('admin.params.roles.form_add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <!-- /Container -->
        </div>
        <!-- /main-content -->
...
<?php echo $__env->make('admin/uncod/layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uncode2/resources/views/admin/params/roles/create.blade.php ENDPATH**/ ?>