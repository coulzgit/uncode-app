							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pr-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										...
										<div class="my-auto">
											<strong class="mr-2 ml-2 my-auto"><?php echo e(__('English')); ?></strong>
										</div>
									</a>
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="#" class="dropdown-item d-flex ">
											<span class="avatar  mr-3 align-self-center bg-transparent"><img src="<?php echo e(URL::asset('assets/img/flags/french_flag.jpg')); ?>" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2">
										...
										<a href="#" class="dropdown-item d-flex">
											<span class="avatar  mr-3 align-self-center bg-transparent"><img src="<?php echo e(URL::asset('assets/img/flags/us_flag.jpg')); ?>" alt="img"></span>
											<div class="d-flex">
...
<!-- /main-header -->
<?php /**PATH /Users/mac/Sites/projets/web/uncode-app/resources/views/admin/uncod/layouts/main-header.blade.php ENDPATH**/ ?>