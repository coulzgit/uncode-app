...
<?php $__env->startSection('content'); ?>
		...
		<div class="main-error-wrapper  page page-h ">
			...
			<h6>You may have mistyped the address or the page may have moved.</h6><a class="btn btn-outline-danger" href="<?php echo e(url('/' . $page='index')); ?>">Back to Home COULZ</a>
		</div>
		<!-- /Main-error-wrapper -->
<?php $__env->stopSection(); ?>
<?php $__env->startSection('js'); ?>
<?php $__env->stopSection(); ?><?php /**PATH /Users/mac/Sites/projets/web/uncode-app/resources/views/admin/404.blade.php ENDPATH**/ ?>