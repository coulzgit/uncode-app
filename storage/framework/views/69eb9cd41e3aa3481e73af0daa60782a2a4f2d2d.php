				...
				<div class="pd-30 pd-sm-40 bg-gray-200">
					<div class="row row-xs align-items-center mg-b-20">
						...
						<div class="col-md-8 mg-t-5 mg-md-t-0">
							<input class="form-control" placeholder="<?php echo e(__('Saisir le numéro du compte')); ?>" type="text">
						</div>
					</div>
...
<?php /**PATH /Users/mac/Sites/projets/web/uncode-app/resources/views/admin/uncod/comptes_clients/add_user/form_add.blade.php ENDPATH**/ ?>