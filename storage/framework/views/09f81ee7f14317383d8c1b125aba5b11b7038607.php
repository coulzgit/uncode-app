                 ...
                 <table class="table text-md-nowrap dataTable no-footer" id="example1" role="grid" aria-describedby="example1_info">
					...
					<tbody>
						...
						<tr role="row" class="odd">
							...
							<td>actif</td>
							<td>
								<a title="<?php echo e(__('Détails de l\'utilisateur')); ?>" href="<?php echo e(route('users.show',['user_id'=>1,'locale'=>app()->getLocale()])); ?>" class="btn btn-sm btn-primary">
									<i class="las la-search"></i>
								</a>
								<a title="<?php echo e(__('Modifier l\'utilisateur')); ?>" href="<?php echo e(route('users.edit',['user_id'=>1,'locale'=>app()->getLocale()])); ?>" class="btn btn-sm btn-info">
									<i class="las la-pen"></i>
								</a>
								<a title="<?php echo e(__('Supprimer l\'utilisateur')); ?>" href="<?php echo e(route('users.delete',['user_id'=>1,'locale'=>app()->getLocale()])); ?>" class="btn btn-sm btn-danger">
...
<?php /**PATH /Users/mac/Sites/projets/web/uncode-app/resources/views/admin/uncod/users/table.blade.php ENDPATH**/ ?>